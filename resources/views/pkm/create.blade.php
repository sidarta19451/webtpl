...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Data PKM</h6>
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul_pkm" class="form-control" required>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="luaran_wajib" class="form-control" rows="3" required></textarea>
                    </div>
                </div>
            </div>
